 ...
 * @param excludeCategoriaSlug - (Opcional) El slug de la categoría a excluir de los resultados.
 */
export const getPrestadores = async (
    categoriaSlug?: string,
    searchTerm?: string,
    excludeCategoriaSlug?: string
  ...
  if (excludeCategoriaSlug) {
    params.append('exclude_categoria', excludeCategoriaSlug);
  }
